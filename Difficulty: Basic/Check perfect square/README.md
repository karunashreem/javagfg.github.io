<h2><a href="https://www.geeksforgeeks.org/problems/check-perfect-square2503/1?page=1&difficulty=Basic&status=unsolved&sortBy=submissions">Check perfect square</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer n, check if it is perfect square or not.</span><br>
