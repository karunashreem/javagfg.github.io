<h2><a href="https://www.geeksforgeeks.org/problems/merge-and-sort5821/1?page=1&difficulty=Basic&status=unsolved&sortBy=submissions">Merge and Sort</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two arrays of length N and M, print the merged array in ascending order containing only unique elements.</span></p>
